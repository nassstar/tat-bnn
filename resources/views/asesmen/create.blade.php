            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">Tambah Data Klien TAT</h1>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        <div>
                            ...
                            <input type="text" name="no_register" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" placeholder="Cth: REG/TAT/001/2026">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">No / BLN</label>
                            <input type="text" name="no_bln" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Asal Pengajuan</label>
                            <input type="text" name="asal_pengajuan" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">No. Surat Pengajuan</label>
                            <input type="text" name="no_surat_pengajuan" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">No. LKN / LP / LI</label>
                            <input type="text" name="no_lkn" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Tanggal Surat</label>
                            <input type="text" name="tgl_surat" class="datepicker-id block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" placeholder="Pilih Tanggal">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Tanggal Berkas Diterima</label>
                            <input type="text" name="tgl_berkas" class="datepicker-id block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" placeholder="Pilih Tanggal">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Tanggal Pelaksanaan</label>
                            <input type="text" name="tgl_pelaksanaan" class="datepicker-id block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" placeholder="Pilih Tanggal">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Tanggal Penangkapan</label>
                            <input type="text" name="tgl_tangkap" class="datepicker-id block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" placeholder="Pilih Tanggal">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        <div>
                            ...
                            <input type="text" name="nama_lengkap" required class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                        <div>
                            ...
                            <input type="text" name="nik" required maxlength="16" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" placeholder="16 Digit NIK">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">No. Handphone</label>
                            <input type="text" name="no_hp" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Tempat Lahir</label>
                            <input type="text" name="tempat_lahir" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Tanggal Lahir</label>
                            <input type="text" name="tgl_lahir" class="datepicker-id block w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" placeholder="Pilih Tanggal">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="kewarganegaraan" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" value="WNI">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="pendidikan_input" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Pekerjaan</label>
                            <input type="text" name="pekerjaan_input" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Penghasilan Rata-Rata</label>
                            <input type="text" name="penghasilan_rata_rata" id="penghasilan_rupiah" placeholder="Misal: Rp 3.000.000" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5 border-t border-slate-100 pt-5">
                        <div>
                            ...
                            <textarea name="alamat_ktp" rows="3" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 sm:text-sm transition-all bg-slate-50 focus:bg-white"></textarea>
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Alamat Domisili Saat Ini</label>
                            <textarea name="alamat_domisili" rows="3" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 sm:text-sm transition-all bg-slate-50 focus:bg-white"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="berat_bb" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-amber-500 focus:ring-2 focus:ring-amber-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" placeholder="Contoh: 2.50">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Status Hukum</label>
                            <input type="text" name="status_hukum" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-amber-500 focus:ring-2 focus:ring-amber-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" placeholder="Cth: Tersangka">
                        </div>
                        <div class="md:col-span-2 lg:col-span-3">
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Deskripsi Barang Bukti</label>
                            <textarea name="deskripsi_bb" rows="2" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-amber-500 focus:ring-2 focus:ring-amber-100 sm:text-sm transition-all bg-slate-50 focus:bg-white"></textarea>
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Pasal Sangkaan</label>
                            <input type="text" name="pasal_sangkaan" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-amber-500 focus:ring-2 focus:ring-amber-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Keterlibatan Jaringan</label>
                            <input type="text" name="keterlibatan_jaringan" placeholder="Ya / Tidak" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-amber-500 focus:ring-2 focus:ring-amber-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Hasil Tes Urine</label>
                            <input type="text" name="tes_urine" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-amber-500 focus:ring-2 focus:ring-amber-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" placeholder="Cth: Positif Sabu">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Cara Mendapatkan</label>
                            <input type="text" name="cara_mendapatkan" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-amber-500 focus:ring-2 focus:ring-amber-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                        <div class="md:col-span-2 text-sm">
                            ...
                            <input type="text" name="dapat_dari_siapa" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-amber-500 focus:ring-2 focus:ring-amber-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <textarea name="hasil_asesmen_hukum" rows="4" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-slate-500 focus:ring-2 focus:ring-slate-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" placeholder="Ketik kronologi mentah asesmen hukum..."></textarea>
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Hasil Asesmen Medis</label>
                            <textarea name="hasil_asesmen_medis" rows="4" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-slate-500 focus:ring-2 focus:ring-slate-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" placeholder="Ketik kronologi mentah asesmen medis..."></textarea>
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Rekomendasi TAT</label>
                            <input type="text" name="rekomendasi_input" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-slate-500 focus:ring-2 focus:ring-slate-100 sm:text-sm transition-all bg-slate-50 focus:bg-white" placeholder="Cth: Rawat Inap RSJ">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Status Pelaksanaan TAT</label>
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-[12px] font-bold text-slate-700 uppercase tracking-wide mb-1">Keterangan Tambahan</label>
                            <input type="text" name="keterangan_tambahan" class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-slate-500 focus:ring-2 focus:ring-slate-100 sm:text-sm transition-all bg-slate-50 focus:bg-white">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-indigo-50/50 to-purple-50/50 p-6 md:p-8 rounded-2xl border border-indigo-100 shadow-sm relative overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <textarea name="aspek_hukum" rows="3" class="block w-full rounded-xl border-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 sm:text-sm transition-all bg-white/80 focus:bg-white"></textarea>
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-indigo-900 uppercase tracking-wide mb-1">Aspek Medis</label>
                            <textarea name="aspek_medis" rows="3" class="block w-full rounded-xl border-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 sm:text-sm transition-all bg-white/80 focus:bg-white"></textarea>
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-indigo-900 uppercase tracking-wide mb-1">Kesehatan Fisik</label>
                            <textarea name="kesehatan_fisik" rows="2" class="block w-full rounded-xl border-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 sm:text-sm transition-all bg-white/80 focus:bg-white"></textarea>
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-indigo-900 uppercase tracking-wide mb-1">Kondisi Psikologi</label>
                            <textarea name="psikologi" rows="2" class="block w-full rounded-xl border-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 sm:text-sm transition-all bg-white/80 focus:bg-white"></textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:col-span-2 mt-2 pt-4 border-t border-indigo-100/50">
                             <div>
                                ...
                                <textarea name="alasan_penggunaan" rows="2" class="block w-full rounded-xl border-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 sm:text-sm transition-all bg-white/80 focus:bg-white"></textarea>
                            </div>
                            <div>
                                <label class="block text-[12px] font-bold text-indigo-900 uppercase tracking-wide mb-1">Kondisi Keluarga</label>
                                <textarea name="kondisi_keluarga" rows="2" class="block w-full rounded-xl border-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 sm:text-sm transition-all bg-white/80 focus:bg-white"></textarea>
                            </div>
                        </div>

                        <div>
                            <label class="block text-[12px] font-bold text-indigo-900 uppercase tracking-wide mb-1">Tingkat Ketergantungan</label>
                            <input type="text" name="tingkat_ketergantungan" class="block w-full rounded-xl border-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 sm:text-sm transition-all bg-white/80 focus:bg-white">
                        </div>
                        <div>
                            <label class="block text-[12px] font-bold text-indigo-900 uppercase tracking-wide mb-1">Pola Pemakaian</label>
                            <input type="text" name="pola_pemakaian" class="block w-full rounded-xl border-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 sm:text-sm transition-all bg-white/80 focus:bg-white">
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-[12px] font-bold text-indigo-900 uppercase tracking-wide mb-1">Kondisi Lingkungan</label>
                            <textarea name="kondisi_lingkungan" rows="2" class="block w-full rounded-xl border-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 sm:text-sm transition-all bg-white/80 focus:bg-white"></textarea>
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-[12px] font-bold text-indigo-900 uppercase tracking-wide mb-1">Saran Sidang Case Conference</label>
                            <textarea name="saran_case_conference" rows="4" class="block w-full rounded-xl border-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 sm:text-sm transition-all bg-white/80 focus:bg-white"></textarea>
                        </div>
                    </div>
                </div>
