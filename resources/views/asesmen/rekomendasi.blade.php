    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white p-6 rounded-xl border border-slate-200 shadow-xs">
                <h3 class="text-lg font-bold text-slate-800 mb-4">Form Surat Rekomendasi</h3>
                <hr class="mb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div>
                        <p class="text-sm text-slate-500">Rekomendasi Rehabilitasi</p>
                        <!-- Pastikan relasi rekomendasi sudah benar sesuai model Anda -->
                        <p class="font-medium text-purple-700">{{ $asesmen->rekomendasi->tempat_rehabilitasi ?? 'Belum ada data rekomendasi' }}</p>
                    </div>
                </div>

                <div class="p-4 bg-purple-50 text-purple-700 rounded-lg border border-purple-200">
                    Desain dan isi form Surat Rekomendasi bisa Anda letakkan di sini.
                </div>
