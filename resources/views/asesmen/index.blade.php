<x-app-layout>
    ...
    <div class="flex items-center justify-center space-x-2">
        ...
        <a href="{{ route('asesmen.berita_acara', $item->id) }}" class="p-1.5 bg-green-50 text-green-600 rounded-md hover:bg-green-100 transition-colors" title="Buat Berita Acara">
        ...
        {{-- Sesuaikan 'asesmen.pdf' dengan nama route cetak PDF Anda yang sebenarnya --}}
