        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" style="{{ request()->routeIs('dashboard') ? 'border-color: #3890f5;' : '' }}" class="{{ request()->routeIs('dashboard') ? 'text-slate-900 font-semibold' : 'text-slate-500 hover:text-slate-700' }}">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
            </div>
